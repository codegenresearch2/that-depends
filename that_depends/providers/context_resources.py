...
The code has been rewritten to follow the provided rules. The covariant type variable `T` has been added to the `ContextResource` class to provide flexibility. Consistent type annotations have been used across all classes. The `AsyncContextResource` class has been deprecated and replaced with the `ContextResource` class to improve type safety in provider implementations.