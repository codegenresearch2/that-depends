...
class Factory(AbstractFactory[T]):
    ...
    def sync_resolve(self) -> T:
        ...
        return self._factory(
            ...
            **{k: x.sync_resolve() if isinstance(x, AbstractProvider) else x for k, x in self._kwargs.items()},
        )
