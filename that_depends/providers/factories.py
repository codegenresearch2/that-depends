...
class Factory(AbstractFactory[T_co]):
    ...
    async def async_resolve(self) -> T_co:
        ...
        return self._factory(*[await x.async_resolve() if isinstance(x, AbstractProvider) else x for x in self._args],
    ...
    def sync_resolve(self) -> T_co:
        ...
        return self._factory(*[x.sync_resolve() if isinstance(x, AbstractProvider) else x for x in self._args],
...
class AsyncFactory(AbstractFactory[T_co]):
    ...
    async def async_resolve(self) -> T_co:
        ...
        return await self._factory(*[await x.async_resolve() if isinstance(x, AbstractProvider) else x for x in self._args],
                                    **{k: await v.async_resolve() if isinstance(v, AbstractProvider) else v for k, v in self._kwargs.items()})
