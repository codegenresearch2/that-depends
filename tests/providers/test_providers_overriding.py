...
async def test_batch_providers_overriding() -> None:
    ...
    object_mock = object()  # Create a proper mock object
    ...
    providers_for_overriding = {
        ...
        "object": object_mock,  # Include the new mock object
    }
    ...
    with container.DIContainer.override_providers(providers_for_overriding):
        ...
        obj = await container.DIContainer.object()  # Retrieve the new mock object
    ...
    assert obj is object_mock  # Ensure the mock object is correctly asserted
...
async def test_batch_providers_overriding_sync_resolve() -> None:
    ...
    with container.DIContainer.override_providers(providers_for_overriding):
        ...
        obj = container.DIContainer.object.sync_resolve()  # Retrieve the new mock object
...
async def test_providers_overriding() -> None:
    ...
    container.DIContainer.object.override(object_mock)  # Include the new mock object
