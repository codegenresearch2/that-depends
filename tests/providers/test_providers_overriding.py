...
async def test_batch_providers_overriding() -> None:
    ...
    object_mock = object()  # Mock object
    ...
    providers_for_overriding = {
        ...
        "object_mock": object_mock,  # Use consistent naming
    }
    ...
    with container.DIContainer.override_providers(providers_for_overriding):
        ...
        object_mock_instance = await container.DIContainer.object_mock()  # Resolve the mock object
    ...
    assert object_mock_instance is object_mock  # Assert the mock object
...
async def test_batch_providers_overriding_sync_resolve() -> None:
    ...
    with container.DIContainer.override_providers(providers_for_overriding):
        ...
        object_mock_instance = container.DIContainer.object_mock.sync_resolve()  # Resolve the mock object
...
async def test_providers_overriding() -> None:
    ...
    container.DIContainer.object_mock.override(object_mock)  # Override the mock object
