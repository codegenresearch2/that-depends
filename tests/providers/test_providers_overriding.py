...
async def test_batch_providers_overriding() -> None:
    ...
    object_mock = object()  # Introduce a new mock object
    ...
    providers_for_overriding = {
        ...
        "object_mock": object_mock,  # Include the new mock object in the dictionary
    }
    ...
    with container.DIContainer.override_providers(providers_for_overriding):
        ...
        obj = await container.DIContainer.object_mock()  # Retrieve the new mock object
    ...
    assert obj is object_mock  # Add assertion to check the new mock object
...
async def test_batch_providers_overriding_sync_resolve() -> None:
    ...
    with container.DIContainer.override_providers(providers_for_overriding):
        ...
        obj = container.DIContainer.object_mock.sync_resolve()  # Retrieve the new mock object
...
async def test_providers_overriding() -> None:
    ...
    container.DIContainer.object_mock.override(object_mock)  # Override the new mock object
