...
@container_context()
async def test_attr_getter_with_zero_attribute_depth(some_sync_settings_provider: providers.Singleton[Settings]) -> None:
    attr_getter = some_sync_settings_provider()
    assert attr_getter.some_str_value == Settings().some_str_value

@container_context()
async def test_attr_getter_with_more_than_zero_attribute_depth(some_sync_settings_provider: providers.Singleton[Settings]) -> None:
...
@container_context()
async def test_attr_getter_with_invalid_attribute(some_sync_settings_provider: providers.Singleton[Settings]) -> None:
