...
@dataclass
class Nested1:
    nested2_attr = field(default_factory=Nested2)

@dataclass
class Settings:
    some_str_value = "some_string_value"
    some_int_value = 3453621
    nested1_attr = field(default_factory=Nested1)
...
@pytest.fixture
async def some_settings_provider() -> providers.Singleton[Settings]:
